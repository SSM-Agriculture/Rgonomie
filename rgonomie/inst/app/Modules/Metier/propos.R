      ...
      column(12,
             ...
             h4(i18n$t("Les utilisateurs qui désirent se former peuvent consulter par exemple "),
                tags$a(href = "https://ssm-agriculture.github.io/site-formations-R/", 
                       i18n$t("sur ce site."))),
             br(),
             h3(i18n$t("Mode d'emploi")),
             h4(i18n$t("Le diaporama de formation pour l'utilisation de l'application Rgonomie est disponible "),
                tags$a(href = "https://ssm-agriculture.github.io/formation-rgonomie",
                       i18n$t("sur cette page."))),
             br(),          
